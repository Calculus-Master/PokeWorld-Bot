...
public class Move
{
    ...
    public static final List<String> WIP_MOVES = Arrays.asList("Roar", "Hail", "Sweet Scent", "Smokescreen", "Protect", "Rain Dance", "Safeguard", "Whirlwind", "Rage Powder", "Tailwind", "Light Screen");
    public static final List<String> CUSTOM_MOVES = Arrays.asList("Leech Seed", "Toxic", "Rapid Spin", "Fell Stinger", "Toxic Spikes");
