...
public class Move
{
    ...
    public static final List<String> WIP_MOVES = Arrays.asList("Roar", "Sweet Scent", "Smokescreen", "Protect", "Rain Dance", "Safeguard", "Whirlwind", "Rage Powder", "Tailwind", "Light Screen", "Lock On");
