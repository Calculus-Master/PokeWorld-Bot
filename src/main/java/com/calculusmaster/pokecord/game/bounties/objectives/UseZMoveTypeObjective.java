...
public class UseZMoveTypeObjective extends Objective
{
    private Type type;

    public UseZMoveTypeObjective()
    {
        super(ObjectiveType.USE_ZMOVE_TYPE, Objective.randomTargetAmount(2, 10));
    ...
    public UseZMoveTypeObjective setType(String type)
    {
