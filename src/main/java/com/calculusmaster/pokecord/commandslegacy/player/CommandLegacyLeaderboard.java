...
public class CommandLegacyLeaderboard extends CommandLegacy
{
    ...
    public CommandLegacyLeaderboard(MessageReceivedEvent event, String[] msg)
    {
        super(event, msg);
    }
    ...
    enum ScoreComponent
    {
        ...
        TMS(1.5, p -> p.getInventory().getTMCount(), "TMs"),
        ITEMS(0.75, p -> p.getInventory().getItemCount(), "Items"),
        ...
        double calculateZScore(String ID)
        {
            ...
            {
                LoggerHelper.reportError(CommandLegacyLeaderboard.class, "Divide by zero when calculating Z-Score (StdDev is 0)", e);
                return 0;
            }
        }
