...
public class CommandLegacyShop extends CommandLegacy
{
    ...
    public CommandLegacyShop(MessageReceivedEvent event, String[] msg)
    {
...
//                    else for(String s : selected.getFormsList()) availableForms.append(s).append("\n");
                ...
                else if(Page.TM.matches(this.msg[1]))
                {
                    ...
                    this.embed.addField("Price", "Each TM costs `" + CommandLegacyShop.TM_PRICE + "` credits!", false);
    ...
    {
        LoggerHelper.info(CommandLegacyShop.class, "Updating Shop!");
