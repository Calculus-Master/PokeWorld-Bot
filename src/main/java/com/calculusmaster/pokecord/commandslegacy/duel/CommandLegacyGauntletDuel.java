...
public class CommandLegacyGauntletDuel extends CommandLegacy
{
    public CommandLegacyGauntletDuel(MessageReceivedEvent event, String[] msg)
    {
        super(event, msg);
    }
    ...
    {
        if(this.insufficientMasteryLevel(Feature.PVE_DUELS_GAUNTLET)) return this.invalidMasteryLevel(Feature.PVE_DUELS_GAUNTLET);
