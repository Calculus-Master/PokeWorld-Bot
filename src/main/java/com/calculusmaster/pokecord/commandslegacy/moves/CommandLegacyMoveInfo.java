...
public class CommandLegacyMoveInfo extends CommandLegacy
{
    public CommandLegacyMoveInfo(MessageReceivedEvent event, String[] msg)
    {
        super(event, msg);
    }
    ...
    {
        this.response = "The text-based command is deprecated. Please use /moveinfo instead.";
