...
public class PokemonRarity
{
    ...
    public static final List<String> MYTHICAL = Arrays.asList("Mew", "Celebi", "Jirachi", "Uxie", "Mespirit", "Azelf", "Phione", "Manaphy", "Shaymin", "Shaymin Sky", "Victini", "Meloetta Pirouette", "Genesect", "Diancie", "Mega Diancie", "Hoopa", "Hoopa Unbound", "Tapu Koko", "Tapu Lele", "Tapu Bulu", "Tapu Fini", "Magearna", "Marshadow", "Zeraora", "Zarude");
